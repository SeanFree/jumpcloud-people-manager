...
import { selectAllUsers, selectGetUsersStatus } from 'store/users/users.selectors';
...
const UsersTile: FC = () => {
  ...
  const { setNotificationMessage, setSidePanelAction, setUserUnderEdit } = useContext(AppContext);
  const [fetchError, setFetchError] = useState(false);
  const users = useData<SystemUsersList, SystemUser[], void>($getAllUsers, selectAllUsers);
